				...
				<div class="row clearfix">
						<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
							<div class="card card-box">
								<img
									class="card-img-top"
									src="back/vendors/images/img1.jpg"
									alt="Card image cap"
								/>
								<div class="card-body">
									<h5 class="card-title weight-500">FUND WALLET</h5>
									<p class="card-text">
									You can fund your wallet for making payment, by using your bank debit card. 									
									</p>
									<a href="{{ route('load-wallet') }}" class="btn btn-primary">Fund Wallet</a>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
							<div class="card card-box">
								<img
									class="card-img-top"
									src="back/vendors/images/img2.jpg"
									alt="Card image cap"
								/>
								<div class="card-body">
									<h5 class="card-title weight-500">WALLET PAY</h5>
									<p class="card-text">
										This allows you to make payment on your portal through your wallet.
									</p>
									<a href="{{ route('pay-wallet') }}" class="btn btn-success">Pay from Wallet</a>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
							<div class="card card-box">
								<img
									class="card-img-top"
									src="back/vendors/images/img3.jpg"
									alt="Card image cap"
								/>
								<div class="card-body">
									<h5 class="card-title weight-500">TRANSFER FUNDS</h5>
									<p class="card-text">
										This enables you to transfer funds from your wallet to another user within the portal.
									</p>
									<a href="{{ route('pay-other-wallet') }}" class="btn btn-warning">Transfer Funds</a>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
							<div class="card card-box">
								<img
									class="card-img-top"
									src="back/vendors/images/img4.jpg"
									alt="Card image cap"
								/>
								<div class="card-body">
									<h5 class="card-title weight-500">TRANSACTION HISTORY</h5>
									<p class="card-text">
									Record of all transactions associated with your wallet, financial interactions and balances over time.
									</p>
									<a href="{{ route('transaction-history') }}" class="btn btn-info">Preview</a>
								</div>
							</div>
						</div>
					</div>
