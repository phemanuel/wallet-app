					...
					<table class="data-table table nowrap">
						<thead>
							<tr>
								...
								<th class="table-plus">Wallet ID</th>
                                <th class="table-plus">Recieved From</th>
								<th>Amount</th>
				...
				<tr>
					...
					<td class="table-plus">
						<div class="name-avatar d-flex align-items-center">										
							<div class="txt">
								<div class="weight-600">{{ $rs->reciever_wallet_id }}</div>
							</div>
						</div>
					</td>
                    <td class="table-plus">
						<div class="name-avatar d-flex align-items-center">										
							<div class="txt">
								<div class="weight-600">{{ $rs->sender_wallet_id }}</div>
                                <div class="weight-600">{{ $rs->sender_full_name }}</div>
							</div>
						</div>
					</td>
