										...
										<div class="tab-content">										
											...
											>
												<div class="profile-setting">
													<form action="{{ route('flicks-pay') }}" method="POST">
														@csrf
														<!-- @method('PUT')														 -->
														<ul class="profile-edit-list row">
															...
															@endif
																...
																<div class="form-group">
																	<label><strong>Wallet ID</strong> </label>
																	<p> {{ $data['wallet_id'] }} </p>		
																</div>
																...
																<div class="form-group">
																	...
																	<p> =N={{ number_format($data['amount'],2) }}</p>																	
																</div>
																<div class="form-group">
																	<label><strong>Amount Due(Transaction charges inclusive)</strong></label>
																	<p> =N={{ number_format($data['amount_due'],2) }}</p>																	
																</div>

																<div class="form-group mb-0">
																<input name="merchant_id" type="hidden" value="{{ $data['merchant_id'] }}" />
																<input name="product_id" type="hidden" value="{{ $data['product_id'] }}" />
																<input name="product_description" type="hidden" value="{{ $data['product_description'] }}" />
																<input name="amount" type="hidden" value="{{ $data['total_amount_due'] }}" />
																<input name="currency" type="hidden" value="{{ $data['currency'] }}" />
																<input name="transaction_id" type="hidden" value="{{ $data['transaction_id'] }}" />
																<input name="response_url" type="hidden" value="{{ $data['response_url'] }}">
																<input name="email" type="hidden" value="{{ $data['email'] }}" />
																<input name="customer_id" type="hidden" value="{{ $data['std_no'] }}" />
																<input name="phone_no" type="hidden" value="{{ $data['phone_no'] }}" />
																<input name="payment_params" type="hidden" value="{{ $data['payment_params'] }}"/>
																<input name="hash" type="hidden" value="{{ $data['hashed_string'] }}" />
																	<input
																		type="submit"
							...
							<ul class="nav nav-tabs customtab" role="tablist">
								...
								<p align='center'>
									...
									/>
										...
										<p>Note: Please take note of the <strong> Transaction Reference Number</strong>, and you can print the 
										<a href="#" onclick="window.print()"><strong><u>Payment Summary page</u></strong></strong></a></p>
