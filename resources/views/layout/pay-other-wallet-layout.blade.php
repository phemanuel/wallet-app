										...
										<div class="tab-content">										
											...
											>
												<div class="profile-setting">
													<form action="{{ route('pay-other-wallet-action') }}" method="POST">
														@csrf	
														@if($errors->any())
														...
														<ul class="profile-edit-list row">
															...
															@endif
																<p class="text-blue h6 mb-12">
																	Enter the Wallet ID you are transferring funds to for verification.
																</p>
																<hr>
																<div class="form-group">
																	<label>Wallet ID</label>
																	<input type="text" name="wallet_id" class="form-control form-control-lg">																	
																</div> 
