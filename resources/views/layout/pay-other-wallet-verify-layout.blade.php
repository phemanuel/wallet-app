										...
										<div class="tab-content">										
											...
											>
												<div class="profile-setting">
													<form action="{{ route('pay-other-wallet-save') }}" method="POST">
														@csrf														
														<ul class="profile-edit-list row">
															...
															@endif
																...
																<div class="form-group">
																	<strong><label>Wallet ID (Sender)</label></strong>
																	<p> {{auth()->user()->wallet_id }} </p>																	
																</div>
																<hr>
																<strong><p class="text-blue h6 mb-12">Reciever's Information</p></strong>
																<hr>
                                                                <div class="form-group">
																	<strong><label>Wallet ID (Reciever)</label></strong>
																	<p> {{ $wallet_id }} </p>																	
																</div>
																...
																<hr>
																<div class="form-group">
																	<strong><label>Amount to transfer</label></strong>
																	<input type="text" name="amount" class="form-control form-control-lg">																	
																</div> 

																<div class="form-group mb-0">
                                                                <input type="hidden" name="reciever_account_id" value="{{ $account_id }}"/>
                                                                <input type="hidden" name="sender_account_id" value="{{ auth()->user()->id }}"/>																	
                                                                    <input type="hidden" name="sender_email" value="{{ auth()->user()->email }}"/>
																	<input type="hidden" name="reciever_email" value="{{ $email }}"/>
																	<input type="hidden" name="sender_full_name" value="{{ auth()->user()->full_name }}"/>
                                                                    <input type="hidden" name="reciever_full_name" value="{{ $full_name }}"/>
																	<input type="hidden" name="sender_phone_no" value="{{ auth()->user()->phone_no }}"/>
                                                                    <input type="hidden" name="reciever_phone_no" value="{{ $phone_no }}"/>
																	<input type="hidden" name="sender_wallet_id" value="{{ auth()->user()->wallet_id }}"/>
                                                                    <input type="hidden" name="reciever_wallet_id" value="{{ $wallet_id }}"/>

																	<input type="hidden" name="sender_wallet_balance" value="{{ auth()->user()->wallet_balance }}"/>
																	<input type="hidden" name="reciever_wallet_balance" value="{{ $wallet_balance }}"/>
																	<input type="hidden" name="sender_total_money_transfer" value="{{ auth()->user()->total_money_transfer }}"/>
																	<input type="hidden" name="reciever_total_money_recieved" value="{{ $total_money_recieved }}"/>
																	<input
																		type="submit"
