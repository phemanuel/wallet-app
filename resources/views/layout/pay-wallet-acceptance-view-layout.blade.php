										...
										<ul class="nav nav-tabs customtab" role="tablist">
											...
											<li class="nav-item">
												<a
													...
													href="#setting"
													role="tab"
													>Acceptance Fee for {{ $stdSession }} academic session</a
												>
											</li>
										</ul>
										<div class="tab-content">										
											...
											>
												<div class="profile-setting">
													<form action="{{ route('pay-wallet-acceptance-action')}}" method="POST">
														@csrf	
														@if($errors->any())
														...
														<ul class="profile-edit-list row">
															...
															@endif
																...
																<hr>
																<div class="form-group">
																<label><strong>Total Fee to pay now</strong> </label>
