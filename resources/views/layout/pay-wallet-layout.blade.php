		...
		<div class="main-container">
			...
			@if(session('success'))
				...
				@foreach ($result as $item)
					<h2 class="h3 mb-0">Payment for {{ $item['session'] }} Academic Session </h2>
					@endforeach
				</div>
						...
						<div class="card-box height-100-p pd-20 min-height-200px">
							...
							<div class="user-list">
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="back/vendors/images/b1.png"
											...
											<div class="txt">
												...
												<div class="font-14 weight-600">Acceptance Fee</div>
												<div class="font-12 weight-500" data-color="#000099">
												@foreach ($result as $item)
								@if ($item['acceptanceData']->isNotEmpty())
									<ul>
										@foreach ($item['acceptanceData'] as $sessionItem)
											<strong><li>Total Fee: =N={{ number_format($sessionItem->accepfee,2) }}</li></strong>
											
										@endforeach
									</ul>
								@else
									<p>No payment data available for this session.</p>
								@endif
										...
										<div class="cta flex-shrink-0">
											...
											<a href="{{ route('pay-wallet-acceptance', ['totalFee' => $sessionItem->accepfee]) }}" class="btn btn-sm btn-outline-success"
												>Pay now</a
											>
											@else
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="back/vendors/images/b2.png"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
											...
											<div class="txt">
												...
												<div class="font-14 weight-600">School Fee</div>
												<div class="font-12 weight-500" data-color="#ff0000">
												@foreach ($result as $item)
								@if ($item['schfeeData']->isNotEmpty())
									<ul>
										@foreach ($item['schfeeData'] as $sessionItem)
											<strong><li>Tuition Fee: =N={{ number_format($sessionItem->tutionfee,2) }}</li></strong>
											<strong><li>Other Charges: =N={{ number_format($sessionItem->otherfee,2) }}</li></strong>
											<strong><li>Total Fee: =N={{ number_format($sessionItem->total,2) }}</li></strong>
											@endforeach
									</ul>
								@else
									<p>No payment data available for this session.</p>
								...
								@endforeach
										...
										<div class="cta flex-shrink-0">
										    @if ($item['schfeeData']->isNotEmpty())
											<a href="{{ route('pay-wallet-school-fee', ['totalFee' => $sessionItem->total]) }}" class="btn btn-sm btn-outline-success"
												>Pay now</a
											>
											@else
											<a href="#" class="btn btn-sm btn-outline-success"
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="back/vendors/images/b3.png"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
											...
											<div class="txt">
												...
												<div class="font-14 weight-600">Departmental Fee</div>
												<div class="font-12 weight-500" data-color="#006600">
												@foreach ($result as $item)
													<!-- {{ $item['paymentlevel'] }} -->
													@if ($item['deptfeeData'])
														<ul>														
															<strong><li>Total Fee: =N={{ number_format($item['deptfeeData']->totalfee, 2) }}</li></strong>
														</ul>
													@else
														<p>No payment data available for this session.</p>
													@endif
										...
										<div class="cta flex-shrink-0">
										    @if($item['deptfeeData'])
											<a href="{{ route('pay-wallet-dept-fee', ['totalFee' => $item['deptfeeData']->totalfee]) }}" class="btn btn-sm btn-outline-success"
												>Pay now</a>
