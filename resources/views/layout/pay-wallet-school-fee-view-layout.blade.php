										...
										<ul class="nav nav-tabs customtab" role="tablist">
											...
											<li class="nav-item">
												<a
													...
													href="#setting"
													role="tab"
													>School Fee for {{ $stdSession }} academic session</a
												>
											</li>
										</ul>
										<div class="tab-content">										
											...
											>
												<div class="profile-setting">
													<form action="{{ route('pay-wallet-school-fee-action')}}" method="POST">
														@csrf	
														@if($errors->any())
														...
														<ul class="profile-edit-list row">
															...
															@endif
																<p class="text-blue h6 mb-12">
																	Check the details below before you proceed.
																</p>
																<hr>
																...
																<hr>
																<div class="form-group">
																<label><strong>Tuition Fee</strong> </label>
																<p>=N={{ number_format($tutionfee, 2) }} </p>	
																<label><strong>Other Charges</strong> </label>	
																<p>=N={{ number_format($otherfee, 2) }}</p>																	
																</div>
																<hr>
																<div class="form-group">
																<label><strong>Total Fee to pay</strong> </label>
																<p>=N={{ number_format($totalFee, 2) }}</p>																		
																</div>
																<hr>
																<div class="form-group">
																<label><strong>Amount pay to date</strong> </label>
																<p>=N={{ number_format($amountpaid, 2) }}</p>																		
																</div>
																<hr>
																<div class="form-group">
																<label><strong>Balance to pay</strong> </label>
																<p>=N={{ number_format($balance, 2) }}</p>																		
																</div>
																<hr>																																
																<div class="form-group">
																	<label><strong>Wallet Balance</strong> </label>
																	<p> =N={{ number_format(auth()->user()->wallet_balance,2) }}</p>		
																</div>
																<hr>
																<div class="form-group">
																<label><strong>Select what you are paying for</strong> </label>
																<select class="form-control" name="pay_type">
																	<option value="Tuition Fee and Other Charges">Tuition Fee and Other Charges</option>
																...
																<input type="hidden" name="wallet_id" value="{{ auth()->user()->wallet_id }}">
																	<input type="hidden" name="std_state" value="{{ auth()->user()->std_state }}">
																	...
																	<input type="hidden" name="std_level" value="{{ $academicLevel }}">
																	<input type="hidden" name="std_session" value="{{ $stdSession }}">
