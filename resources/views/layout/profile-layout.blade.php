										...
										>
											<div class="modal-content">
												...
												<div class="modal-footer">
													<a href="{{ route('profile-picture') }}" class="btn btn-primary">Edit</a>
													<button
														type="button"
															...
															@endif
                                                                ...
                                                                <div class="form-group">
																	...
																	<input
																		...
																		type="text" name="user_name" value="{{ auth()->user()->user_name}} "																	/>
																</div>	
																<div class="form-group">
																...
																<div class="form-group">
																	...
																	<input
																		class="form-control form-control-lg"
																		type="text" name="phone_no" value="{{ auth()->user()->phone_no}} "
																	/>
																</div>
																<div class="form-group">
																	<div
